...
# Detecta colisao.
    ...
    if ((principal_x + 30 > mesclado_x and principal_y + 90 > mesclado_y)) and ((principal_y - 75 < mesclado_y)):
        principal_y = 1200 # Colisao lado direito.
        pygame.time.wait()

    if ((principal_x - 30 < vermelho_x and principal_y + 90 > vermelho_y)) and ((principal_y - 75 < vermelho_y)):
